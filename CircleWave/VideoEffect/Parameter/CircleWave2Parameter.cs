...
{
    internal class CircleWave2Parameter : CircleWaveArgBase, IAmpAngleParameter, IXYParameter
    {
        ...
        [Display(Name = "再生位置", Description = "波の位置")]
        ...
        [Display(Name = "間隔変化", Description = "波の間隔の変化")]
        [AnimationSlider("F2", "", 0, 2)]
        public Animation E { get; } = new Animation(1, 0, 100000);

        public CircleWave2Parameter()
        {
        }

        public CircleWave2Parameter(SharedDataStore? store = null) : base(store)
        {
        }
        ...
        protected override IEnumerable<IAnimatable> GetAnimatables() => [AmpAngle, Wlen, Phase, Speed, Offset, Strd, X, Y, E];
